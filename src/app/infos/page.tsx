            ...
            >
              <div className="space-y-2">
                ...
                >
                  ...
                  gratuites et immersives. Explorez (quelques) œuvres d&#39;art
                  depuis votre canapé (ou votre chaise de gamer) !
                </motion.p>
              </div>
              <motion.div
                variants={itemVariants}
          ...
          >
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-gray-400 sm:text-lg md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                L&#39;AsyncMuseum est dédié à la préservation et à la présentation
                de l&#39;art sous toutes ses formes. Notre mission est de rendre
                l&#39;art accessible à tous, partout dans le monde.
              </p>
            </div>
          </motion.div>
